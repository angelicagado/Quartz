...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-foreground">Create User</h1>
                <p class="mt-0.5 text-sm text-muted-foreground">Add a new user account to the system.</p>
            </div>
        </div>
            ...
            <div class="rounded-xl border border-border bg-card shadow-xs overflow-hidden">
                <div class="flex items-center gap-3 border-b border-border bg-muted/30 px-6 py-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-muted-foreground">Name, email, password and role</p>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="border-t border-border pt-5">
                        <p class="mb-4 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Password</p>
