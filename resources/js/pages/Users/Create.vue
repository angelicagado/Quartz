    ...
    <form @submit.prevent="submit" class="max-w-xl">
      <div class="overflow-hidden rounded-xl border border-border bg-card shadow-xs">
        <div class="flex items-center gap-3 border-b border-border bg-muted/30 px-6 py-4">
          <div
            class="flex size-8 items-center justify-center rounded-lg bg-linear-to-br from-slate-800 from-40% to-[#d4af37]"
          >
            <User class="size-4 text-white" />
          </div>
          <div>
            <h2 class="font-serif font-semibold text-foreground">User Details</h2>
      ...
      <div class="mt-6 flex items-center justify-end gap-3">
        ...
        <Button
          ...
          class="text-white shadow-md bg-linear-to-br from-slate-800 from-40% to-[#d4af37]"
        >
