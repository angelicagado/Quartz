...
const filteredEvents = computed(() => {
    return props.events.filter((event) => {
        ...
        const matchesCertificate =
            ...
            (certificateFilter.value === 'enabled' &&
                event.certificate_enabled) ||
            (certificateFilter.value === 'disabled' &&
                !event.certificate_enabled);
        const matchesEvaluation =
            evaluationFilter.value === 'all' ||
            (evaluationFilter.value === 'required' &&
                event.evaluation_required) ||
            (evaluationFilter.value === 'not_required' &&
                !event.evaluation_required);
...
<template>
    ...
    <div class="mx-auto w-full max-w-7xl">
        ...
        <!-- Filters -->
        <div
            class="hide-scrollbar mb-6 flex items-center gap-2 overflow-x-auto pb-2"
        >
            <button
        ...
        >
            ...
            <div
                v-if="
                    ['admin', 'super_admin'].includes(role) && !hasActiveFilters
                "
                @click="isCreateModalOpen = true"
            ...
            >
                <div class="flex flex-col items-center gap-4">
                    <Search
                        class="h-12 w-12 text-slate-200 dark:text-slate-700"
                    />
                    <div>
                        <p
                        ...
                        <p
                            class="mt-1 font-light text-slate-500 dark:text-slate-400"
                        >
                    ...
                    >
                        <label class="flex cursor-pointer items-center gap-3">
                            ...
                            <div>
                                ...
                                >
                                    Participants must submit feedback before
                        ...
                        <label class="flex cursor-pointer items-center gap-3">
                            ...
                            <div>
                                ...
                                <div
                                    class="text-xs text-slate-500 dark:text-slate-400"
                                >
                                    Automatically generate PDF certificates for
                                    attendees.
                                </div>
                            </div>
                        </label>
