                ...
                <div class="flex shrink-0 gap-6 lg:flex-row lg:items-center">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <button
                            ...
                            class="rounded-2xl bg-slate-900 px-6 py-3 font-bold text-white shadow-lg transition-all hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200"
                        >
                            Edit Event
                        </button>
                    </div>
