    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex shrink-0 items-center gap-2">
                ...
                <Button
                    size="sm"
                    class="gap-2 bg-gradient-to-r from-violet-600 to-indigo-600 text-white"
        ...
        >
                            ...
                            >
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-2.5">
                                        <div
                                            class="flex size-8 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 text-xs font-bold text-white"
                                        >
                                            {{
            ...
            <!-- Pagination -->
            <div
                v-if="participants.meta && participants.meta.last_page > 1"
                class="flex items-center justify-between border-t border-border px-4 py-3"
            >
                <p class="text-sm text-muted-foreground">
                    Showing {{ participants.meta.from }}–{{
                        participants.meta.to
                    }}
                    ...
                    >
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                autofocus
                                :class="{
                                    'border-destructive': addForm.errors.email,
                                }"
                            />
                            <p
                        ...
                        <div class="flex justify-end gap-3 pt-2">
                            ...
                            <Button
                                ...
                                class="bg-gradient-to-r from-violet-600 to-indigo-600 text-white"
                            >
                                {{
                                    addForm.processing
                                        ? 'Adding...'
