  ...
  <div class="flex h-full flex-1 flex-col gap-6 p-6">
    ...
    <div class="mt-8 flex flex-col gap-8 lg:flex-row-reverse">
      ...
      <div class="w-full lg:w-1/3">
        <div
          class="flex flex-col gap-6 rounded-[2.5rem] border border-slate-800 bg-slate-900 p-6 shadow-2xl sm:p-10 dark:border-slate-700 dark:bg-slate-800"
        >
          <div class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <select
                ...
                class="w-full rounded-xl border border-slate-700 bg-slate-800 px-4 py-3 text-sm text-white focus:border-[#d4af37] focus:ring-1 focus:ring-[#d4af37] outline-none"
              >
    ...
    >
      ...
      <div
        ...
        :class="[
          modalData.status === 'success'
            ...
            ? 'ring-1 ring-amber-500/50 shadow-amber-500/20'
      ...
      >
        <div class="flex flex-col items-center text-center">
          ...
          <p
            v-if="modalData.name"
            class="mb-2 text-lg font-medium text-slate-700 dark:text-slate-300"
          >
            {{ modalData.name }}
          </p>
...
const handleScan = async (token: string) => {
  ...
  if (!selectedEventId.value) {
    showModal(
      "warning",
      "Action Required",
      "Please select an event first to start scanning."
    );
  ...
  try {
    ...
    const response = await axios.post(
      `/events/${selectedEventId.value}/attendance/scan`,
      {
        token: cleanToken,
      }
    );
