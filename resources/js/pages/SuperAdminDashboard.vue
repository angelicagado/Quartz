...
<template>
    ...
    <div
        class="mx-auto max-w-7xl animate-in space-y-8 duration-700 fade-in slide-in-from-bottom-4"
    >
        <!-- Header Row -->
        <div
        ...
        >
            <div>
                ...
                <h1
                    class="text-3xl font-semibold tracking-tight text-slate-900 md:text-4xl dark:text-slate-100"
                >
                    Welcome back, {{ adminName }}!
                </h1>
                <p class="mt-2 max-w-xl text-slate-500 dark:text-slate-400">
                    Manage event operations, create certificate templates, and
        ...
        >
            ...
            <Link
                href="/events"
                class="group flex w-full items-center justify-center gap-2 rounded-2xl border border-transparent bg-slate-900 px-7 py-3.5 text-[15px] font-medium text-white shadow-sm transition-all duration-300 hover:bg-[#C5A059] active:scale-[0.98] sm:w-auto"
            >
                <Plus
                    class="h-5 w-5 text-[#C5A059] transition-colors group-hover:text-white"
                />
                Manage Events
            </Link>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 pt-2 md:grid-cols-3">
            ...
            >
                ...
                <div>
                    ...
                    <div
                        class="mt-1 text-5xl font-semibold tracking-tight text-slate-900"
                    >
        ...
        <div class="grid grid-cols-1 gap-6 pt-4 lg:grid-cols-3">
            ...
            >
                <div class="mb-8 flex items-center justify-between">
                    <h3 class="text-[1.15rem] font-semibold text-slate-900">
                        Growth Analysis
                    </h3>
                    <Link
                        href="/reports"
